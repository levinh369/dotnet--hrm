        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (!$('#paging-ul').data("twbs-pagination")) {
                    Dep.showPaging(totalPages, pageIndex);
                }
            },
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.success) {
                    ...
                    toastr.success(res.message);
                    Dep.loadData(currentPage); // đảm bảo currentPage đã khai báo
                } else {
